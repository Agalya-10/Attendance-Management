    ...
    <Box sx={{ display: "flex", height: "100vh" }}>
      <Drawer
        ...
        sx={{width: drawerWidth, flexShrink: 0,
          "& .MuiDrawer-paper": { width: drawerWidth, boxSizing: "border-box", backgroundColor: "#2F8D7B",color: "white",},
        }} >
        <Toolbar>
          <Typography variant="h6" sx={{ fontWeight: "bold", margin: "auto" }}>  Employee MS </Typography>
        </Toolbar>
        <List>
          {[
     ...
     <Box sx={{ flexGrow: 1, bgcolor: "#F1F3F6" }}>
      ...
      <Box sx={{ padding: "20px" }}>
          <Typography variant="h5" fontWeight="bold" marginBottom={2}> Dashboard Overview</Typography>
     <Grid container spacing={2}>
        ...
        <Typography variant="h5" fontWeight="bold" marginTop={3} marginBottom={2}> Leave Details </Typography>
        <Grid container spacing={2}>
            {[
