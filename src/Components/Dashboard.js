    ...
    <Box >
      <Grid2 container spacing={2}sx={{marginLeft:"20px"}}>
        {[
          ...
          <Grid2 item size={3} sm={4} key={index}>
            <Paper
              elevation={3}
              sx={{padding: "20px",
                display: "flex",
      ...
      <Typography variant="h5" fontWeight="bold" marginTop={3} marginBottom={2} marginLeft={2}>
        Leave Details
      </Typography>
      <Grid2 container spacing={2}>
        {[
          ...
          <Grid2 item size={3} sm={3} key={index}sx={{marginLeft:"20px"}}>
            <Paper
              elevation={3}
              sx={{
                padding: " 20px",
