  ...
  return (
    <Box display="flex" justifyContent="center" alignItems="center" minHeight="70vh" p={5}>
      ...
      <Box><img src={ebrainLogo} alt="EBrain Technologies Logo" style={{ width: "150px" }} /></Box>
        ...
        <Typography variant="body1"pt={1}  color="textSecondary">
          Email:{" "}
